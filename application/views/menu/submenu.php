                ...
                <tbody>
                    ...
                    <?php foreach ($subMenu as $sm) : ?>
                        <tr>
                            ...
                            <td><?= $sm['is_active']; ?></td>
                            <td>
                                <button type="button" onclick="showEditSubMenuModal('<?= $sm['id']; ?>','<?= $sm['menu_id']; ?>')" role="button" class="btn btn-sm btn-success">edit</button>

                                <form class="d-inline" action="<?= base_url('menu/delete_submenu'); ?>" method="post">
...
<div class="modal fade" id="editSubMenuModal" tabindex="-1" aria-labelledby="editSubMenuModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="edit_submenu_form" action="<?= base_url('menu/edit_submenu'); ?>" method="POST">
                <div class="modal-body">
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <select name="menu_id" id="menu_id" class="form-control">
                            <option value="">SELECT MENU</option>
                            <?php foreach ($menu as $m) : ?>
                                <option id="menu<?= $m['id']; ?>" value="<?= $m['id']; ?>"><?= $m['menu']; ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    <div class="form-group">
